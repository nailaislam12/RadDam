...
void MakePlots17() {
	...
	TFile *fMC = new TFile("outplots_mc_withPU.root");
	TFile *fData = new TFile("outplots_data_withPU.root");
	...
	TextMassMC.DrawLatex(0.6,0.86,"#scale[1.2]{#font[62]{Inv. mass (MG MLM)}}");
	...
	canvas->Print("Figures17_dataRunBC_withPU/InvMass_mc.pdf");
	canvas->Clear();
	...
	TextMassData.DrawLatex(0.6,0.86,"#scale[1.2]{#font[62]{Inv. mass (42 fb^{-1})}}");
	...
	CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
	canvas->Print("Figures17_dataRunBC_withPU/InvMass_data.pdf");
	canvas->Clear();
	gStyle->SetPadLeftMargin(0.13);
	...
	TH1F *hEtaMinusMCAll = new TH1F("hEtaMinusMCAll", "", 10, 29.5, 39.5);
	...
	for(int i = 30; i <= 39; ++i) {
		...
		TextEtaPlusMC.DrawLatex(0.7,0.86,"#scale[1.4]{i"+EtaPlusBin+" (MG MLM)}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaPlusNameMC = TString::Format("Figures17_dataRunBC_withPU/Eta/EtaPlus%i_mc.pdf", i);
		...
		TextEtaPlusData.DrawLatex(0.7,0.86,"#scale[1.4]{i"+EtaPlusBin+" (42 fb^{-1})}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaPlusNameData = TString::Format("Figures17_dataRunBC_withPU/Eta/EtaPlus%i_data.pdf", i);
		...
		TextEtaMinusMC.DrawLatex(0.7,0.86,"#scale[1.4]{i"+EtaMinusBin+" (MG MLM)}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaMinusNameMC = TString::Format("Figures17_dataRunBC_withPU/Eta/EtaMinus%i_mc.pdf", i);
		...
		TextEtaMinusData.DrawLatex(0.7,0.86,"#scale[1.4]{i"+EtaMinusBin+" (42 fb^{-1})}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaMinusNameData = TString::Format("Figures17_dataRunBC_withPU/Eta/EtaMinus%i_data.pdf", i);
	...
	legendEta->AddEntry(hEtaMCAll, "MG MLM", "l");
	legendEta->AddEntry(hEtaPlusDataAll, "42 fb^{-1} HF+", "ep");
	legendEta->AddEntry(hEtaMinusDataAll, "42 fb^{-1} HF-", "ep");
	legendEta->SetBorderSize(0);
	legendEta->Draw();
	CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
	canvas->Print("Figures17_dataRunBC_withPU/EtaFit.pdf");
	canvas->Clear();
	...
	for(int i = 1; i <= 71; i+=2) {
		...
		TextPhiMC.DrawLatex(0.7,0.86,"#scale[1.4]{i"+PhiBin+" (MG MLM)}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString PhiNameMC = TString::Format("Figures17_dataRunBC_withPU/Phi/Phi%i_mc.pdf", i);
		...
		TextPhiData.DrawLatex(0.7,0.86,"#scale[1.4]{i"+PhiBin+" (42 fb^{-1})}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString PhiNameData = TString::Format("Figures17_dataRunBC_withPU/Phi/Phi%i_data.pdf", i);
	...
	legendPhi->AddEntry(hPhiMCAll, "MG MLM", "ep");
	legendPhi->AddEntry(hPhiDataAll, "42 fb^{-1}", "ep");
	legendPhi->SetLineColor(kWhite);
	legendPhi->SetBorderSize(0);
	legendPhi->Draw();
	CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
	canvas->Print("Figures17_dataRunBC_withPU/PhiFit.pdf");
	canvas->Clear();
	...
	canvas->Print("Figures17_dataRunBC_withPU/nvtx_mc.pdf");
	canvas->Clear();
	...
	canvas->Print("Figures17_dataRunBC_withPU/nvtx_data.pdf");
	canvas->Clear();
	...
	for(int i = 1; i <= 9; ++i) {
		...
		TextPUmc.DrawLatex(0.7,0.86,"#scale[1.4]{"+PUbin[i-1]+" (MG MLM)}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString PUmcName = TString::Format("Figures17_dataRunBC_withPU/PU/PU%i_mc.pdf", i);
		...
		TextPUdata.DrawLatex(0.7,0.86,"#scale[1.4]{"+PUbin[i-1]+" (42 fb^{-1})}");
		...
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString PUdataName = TString::Format("Figures17_dataRunBC_withPU/PU/PU%i_data.pdf", i);
	...
	TString LinFitMC = TString::Format("MG MLM: %.3f + %.3f #times nVtx", funcLinMC->GetParameter(0), funcLinMC->GetParameter(1));
	if (funcLinMC->GetParameter(1) < 0) LinFitMC = TString::Format("MG MLM: %.3f - %.3f #times nVtx", funcLinMC->GetParameter(0), (-1)*funcLinMC->GetParameter(1));
	...
	TString LinFitData = TString::Format("42 fb^{-1}: %.3f + %.3f #times nVtx", funcLinData->GetParameter(0), funcLinData->GetParameter(1));
	if (funcLinData->GetParameter(1) < 0) LinFitData = TString::Format("42 fb^{-1}: %.3f - %.3f #times nVtx", funcLinData->GetParameter(0), (-1)*funcLinData->GetParameter(1));
	...
	legendPU->Draw();
	CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
	canvas->Print("Figures17_dataRunBC_withPU/PUFit.pdf");
	canvas->Clear();
	...
	for (int e = 30; e <= 41; ++e) {		
		...
		TLegend* legendEtaPU = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaPU->AddEntry(hEtaPUData, "42 fb^{-1}", "p");
		legendEtaPU->AddEntry(hEtaPUMC, "MG MLM", "p");
		legendEtaPU->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaPUFitName = TString::Format("Figures/EtaBin/Eta%iPU.pdf", e);
		...
		hEtaPhiData->SetMarkerSize(0.75);
		...
		TLegend* legendEtaPhi = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaPhi->AddEntry(hEtaPhiData, "42 fb^{-1}", "p");
		legendEtaPhi->AddEntry(hEtaPhiMC, "MG MLM", "p");
		legendEtaPhi->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaPhiFitName = TString::Format("Figures/EtaBin/Eta%iPhi.pdf", e);
		...
		hEtaPhiEEData->SetMarkerSize(0.75);
		...
		hEtaPhiEEMC->SetMarkerSize(0.75);
		...
		TLegend* legendEtaPhiEE = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaPhiEE->AddEntry(hEtaPhiEEData, "42 fb^{-1}", "p");
		legendEtaPhiEE->AddEntry(hEtaPhiEEMC, "MG MLM", "p");
		legendEtaPhiEE->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaPhiEEFitName = TString::Format("Figures/EtaBin/Eta%iPhiEE.pdf", e);
		...
		hEtaEtaEEData->SetMarkerSize(0.75);
		...
		hEtaEtaEEMC->SetMarkerSize(0.75);
		...
		TLegend* legendEtaEtaEE = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaEtaEE->AddEntry(hEtaEtaEEData, "42 fb^{-1}", "p");
		legendEtaEtaEE->AddEntry(hEtaEtaEEMC, "MG MLM", "p");
		legendEtaEtaEE->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaEtaEEFitName = TString::Format("Figures/EtaBin/Eta%iEtaEE.pdf", e);
		...
		hEtaDPhiData->SetMarkerSize(0.75);
		...
		TLegend* legendEtaDPhi = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaDPhi->AddEntry(hEtaDPhiData, "42 fb^{-1}", "p");
		legendEtaDPhi->AddEntry(hEtaDPhiMC, "MG MLM", "p");
		legendEtaDPhi->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaDPhiFitName = TString::Format("Figures/EtaBin/Eta%iDPhi.pdf", e);
		...
		TLegend* legendEtaEn = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaEn->AddEntry(hEtaEnData, "42 fb^{-1}", "p");
		legendEtaEn->AddEntry(hEtaEnMC, "MG MLM", "p");
		legendEtaEn->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaEnFitName = TString::Format("Figures/EtaBin/Eta%iEn.pdf", e);
		...
		hEtaEnEEData->SetMarkerSize(0.75);
		...
		TLegend* legendEtaEnEE = new TLegend(0.7,0.75,0.95,0.95,EtaRange[e-30],"NDC");
		legendEtaEnEE->AddEntry(hEtaEnEEData, "42 fb^{-1}", "p");
		legendEtaEnEE->AddEntry(hEtaEnEEMC, "MG MLM", "p");
		legendEtaEnEE->Draw();
		CMSlabel.DrawLatex(0.128,0.955,"#bf{CMS} #it{Preliminary}");
		TString EtaEnEEFitName = TString::Format("Figures/EtaBin/Eta%iEnEE.pdf", e);
