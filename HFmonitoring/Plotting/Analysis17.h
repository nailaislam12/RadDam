...
#ifdef Analysis17_cxx
Analysis17::Analysis17(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/m/mheindl/HF_calibration/Untuplize/output_data.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/m/mheindl/HF_calibration/Untuplize/output_data.root");
      }
...
Int_t Analysis17::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analysis17::LoadTree(Long64_t entry)
{
...
void Analysis17::Init(TTree *tree)
{
...
void Analysis17::Show(Long64_t entry)
{
...
Int_t Analysis17::Cut(Long64_t entry)
{
